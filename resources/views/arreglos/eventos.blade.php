...
@section('title', 'Arreglos para Eventos')

@section('contenido')
    <!--=== Cabecera Parallax ===-->
    <div id="parall-ramos" data-stellar-background-ratio="0.1" data-stellar-vertical-offset="-150">
    </div>
    <!--=== Contenido Principal ===-->
    <main>
        <section class="row arreglos more-send">
            <div class="columns">
                <?php
                    ...
                    $arreglo = $json_output->arreglos[3];
