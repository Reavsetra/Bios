...
@section('title', 'Arreglos Frutales')

@section('contenido')
    <!--=== Cabecera Parallax ===-->
    <div id="parall-frutales" data-stellar-background-ratio="0.1" data-stellar-vertical-offset="-250">
    </div>
    <!--=== Contenido Principal ===-->
    <main>
        <section class="row arreglos more-send">
            <div class="columns">
                <?php
                    ...
                    $arreglo = $json_output->arreglos[5];
